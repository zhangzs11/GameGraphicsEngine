...
eae6320::cResult eae6320::Graphics::cTexture::CreateTextureWIC(eae6320::Graphics::cTexture*& o_texture, const char* const i_path)
{
	...
	if (!(result = newTexture->InitializeWIC(i_path)))
	{
