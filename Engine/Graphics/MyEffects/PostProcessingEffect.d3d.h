#ifndef EAE6320_GRAPHICS_POSTPROCESSING_EFFECT_H
#define EAE6320_GRAPHICS_POSTPROCESSING_EFFECT_H
...
namespace eae6320
{
    namespace Graphics
    {
        ...
        public:
            ...
            // factory function
            static cResult CreatePostProcessingEffect(
            ...
            void SetLitSRV(cView_SRV* i_ScenceTexture) { m_ScenceTexture = i_ScenceTexture; }
        ...
        private:
            ...
            EAE6320_ASSETS_DECLAREDELETEDREFERENCECOUNTEDFUNCTIONS(PostProcessingEffect)
...
#endif // EAE6320_GRAPHICS_POSTPROCESSING_EFFECT_H
